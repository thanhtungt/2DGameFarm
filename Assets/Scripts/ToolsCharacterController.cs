...
public class ToolsCharacterController : MonoBehaviour
{
    ...
    private bool CastRay()
    {
        ...
        if (hit)
        {
            ...
            if (hit.collider.gameObject.name.Contains("Boss"))
            {
                return true;
            }
        }
    ...
    private bool UseToolWorld()
    {
        ...
        foreach (Collider2D collidor in colliders)
        {
            ...
            ChestHit1 hitChest1 = collidor.GetComponent<ChestHit1>();
            PlayerHit hitPlayer = collidor.GetComponent<PlayerHit>();
            ToolHit hitBoss = collidor.GetComponent<ToolHit>();
            if (hitBoss != null && toolbarController.GetItem != null &&
                toolbarController.GetItem.Name == "Kiem" && CastRay() == true)
            {
            ...
            //key mở khóa rương map
            if (hitChest1 != null && toolbarController.GetItem != null &&
                toolbarController.GetItem.Name == "Key" && CastRay() == true)
            {
                ChestHit1.hasPickUpKey = true;
                hitChest1.Hit();
                return true;
            }
            ...
            if (hitPlayer != null && toolbarController.GetItem != null && CastRayPlayer() == true && (toolbarController.GetItem.Name == "Food_Corn" || toolbarController.GetItem.Name == "Food_Parsley"
                    || toolbarController.GetItem.Name == "Food_Potato" || toolbarController.GetItem.Name == "Food_Strawberry" || toolbarController.GetItem.Name == "Food_Tomato" || toolbarController.GetItem.Name == "Meet"))
            {
                hitPlayer.Hit();
                return true;
            }
